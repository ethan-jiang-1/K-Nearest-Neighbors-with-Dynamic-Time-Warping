...
def _load(dt_type):
    ...
    if dt_type == "feature" or dt_type == "feature_time" or dt_type == "feature_freq":
        ...
        x_train_file = open(data_path('train/InertialSignals/body_acc_z_train.txt'), 'r')
        y_train_file = open(data_path('train/y_train.txt'), 'r')
        x_test_file = open(data_path('test/InertialSignals/body_acc_z_test.txt'), 'r')
        y_test_file = open(data_path('test/y_test.txt'), 'r')

    elif dt_type == "raw_acc_o":
        x_train_file_0 = open(data_path('train/InertialSignals/body_acc_x_train.txt'), 'r')
        x_train_file_1 = open(data_path('train/InertialSignals/body_acc_y_train.txt'), 'r')
        x_train_file_2 = open(data_path('train/InertialSignals/body_acc_z_train.txt'), 'r')
        y_train_file = open(data_path('train/y_train.txt'), 'r')
        x_test_file_0 = open(data_path('test/InertialSignals/body_acc_x_test.txt'), 'r')
        x_test_file_1 = open(data_path('test/InertialSignals/body_acc_y_test.txt'), 'r')
        x_test_file_2 = open(data_path('test/InertialSignals/body_acc_z_test.txt'), 'r')
        y_test_file = open(data_path('test/y_test.txt'), 'r')      
